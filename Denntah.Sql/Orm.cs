...
namespace Denntah.Sql
{
    ...
    public static class OrmExtension
    {
        ...
        /// <param name="transaction">Transaction to associate with the command</param>
        /// <returns>Rows affected</returns>
        public static int Insert<T>(this DbConnection conn, IEnumerable<T> dataList, DbTransaction transaction = null)
            where T : class
        {
            TypeDescriber td = TypeHandler.Get<T>();
        ...
        /// <param name="transaction">Transaction to associate with the command</param>
        /// <returns>Rows affected</returns>
        public static Task<int> InsertAsync<T>(this DbConnection conn, IEnumerable<T> dataList, DbTransaction transaction = null, CancellationToken cancellationToken = default)
            where T : class
        {
            TypeDescriber td = TypeHandler.Get<T>();

            return conn.InsertAsync(td.Table, dataList, transaction, cancellationToken);
        }
        ...
        public static Task<int> InsertIfMissingAsync<T>(this DbConnection conn, T data, DbTransaction transaction = null, CancellationToken cancellationToken = default)
            where T : class
        {
            return conn.InsertIfMissingAsync<T>(new List<T> { data }, transaction, cancellationToken);
        }
        ...
        /// <param name="transaction">Transaction to associate with the command</param>
        /// <returns>Rows affected</returns>
        public static int InsertIfMissing<T>(this DbConnection conn, IEnumerable<T> dataList, DbTransaction transaction = null)
            where T : class
        {
            TypeDescriber td = TypeHandler.Get<T>();
        ...
        /// <param name="transaction">Transaction to associate with the command</param>
        /// <returns>Rows affected</returns>
        public static Task<int> InsertIfMissingAsync<T>(this DbConnection conn, IEnumerable<T> dataList, DbTransaction transaction = null, CancellationToken cancellationToken = default)
            where T : class
        {
            TypeDescriber td = TypeHandler.Get<T>();
            IEnumerable<PropertyDescriber> keys = td.Keys;
