...
namespace Denntah.Sql
{
    ...
    public static class ConnectionExtension
    {
        ...
        {
            return conn.InsertAsync(table, new List<Object> { data }, transaction, cancellationToken);
        }
        ...
        /// <param name="transaction">Transaction to associate with the command</param>
        /// <returns>Rows affected</returns>
        public static int Insert(this DbConnection conn, string table, IEnumerable<object> dataList, DbTransaction transaction = null)
        {
        ...
        {
            return conn.InsertIfMissingAsync(table, new List<Object> { data }, pk, transaction, cancellationToken);
        }
